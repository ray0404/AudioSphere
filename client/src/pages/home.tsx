...
export default function Home() {
  ...
  return (
    <div className="flex-1 flex flex-col">
      {/* Header */}
      <header className="bg-gradient-to-b from-secondary to-background p-6 border-b border-neutral/20">
        <div className="flex items-center justify-between">
          ...
          <div className="flex-1 max-w-md mx-8">
            <Input
              ...
              className="bg-white/10 border-neutral/30 text-white placeholder-neutral focus:border-accent focus:bg-white/20"
            />
          </div>
      ...
      <main className="flex-1 overflow-y-auto p-6 pb-24">
        {searchQuery ? (
          ...
          <>
            {/* Greeting */}
            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-white">Good evening</h2>
              ...
              {tracks.length > 0 && (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {tracks.slice(0, 6).map((track) => (
                    <div
                      key={track.id}
                      className="bg-neutral/20 rounded-lg p-4 flex items-center space-x-4 hover:bg-neutral/30 transition-colors cursor-pointer group"
                    ...
                    >
                      ...
                      <div className="ml-auto opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        >
                          <div className="w-3 h-3 border-l-4 border-l-white border-y-2 border-y-transparent ml-0.5" />
                        </button>
                      </div>
                    </div>
                  ))}
            ...
            {isLoading && (
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-4">
                {Array.from({ length: 8 }).map((_, i) => (
                  <div key={i} className="bg-secondary/40 p-4 rounded-lg animate-pulse">
