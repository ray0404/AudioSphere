...
import { ArrowLeft, User, Disc, Music, Play, Pause } from 'lucide-react';
...
export default function Artists() {
  ...
  const artistsArray: Artist[] = Object.values(artists)
    .map(artist => ({
      ...artist,
    ...
    return (
      <div className="flex-1 flex flex-col">
        <header className="bg-gradient-to-b from-secondary to-background p-4 md:p-6 border-b border-neutral/20">
          <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">Artists</h1>
          <p className="text-neutral">Browse music by artist</p>
        </header>
      ...
      <div className="flex-1 flex flex-col">
        <header className="bg-gradient-to-b from-secondary to-background p-4 md:p-6 border-b border-neutral/20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-white mb-2">{selectedArtist.name}</h1>
